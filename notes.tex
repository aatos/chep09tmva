...
Aatos: editor, NN classifiers; Pekka: Sami: MC data, Ritva:, Tomas: Tapio: M.K.; Veikko:

\subsection{HISTORY}
\begin{itemize}
\item 081028 Removed proceedings notes in the Appendix A to separate file {\tt notes.tex}.
