...
compilation this will launch a PDF viewer (by default Firefox browser
...
disable the PDF viewer feature entirely you can set the environment
variable {\tt NOVIEWER} to 1.
