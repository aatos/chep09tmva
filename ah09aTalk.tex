...
\frametitle{Results - Neural Networks}
 were {\bf trained with 5k signal jets and 40k background jets}:
}

\frame{
\frametitle{Results - Support Vector Machine 1/2}

SVM were {\bf trained with 5k signal jets and 40k background jets}:
  \begin{itemize}
  \item The training in SVM scales as O(\# of events in training data$^2$)  
...
\item Same goes for different levels of background efficiency.
\end{itemize}
...
Signal efficiency (\%)  & Background eff. \\
\hline
5.56$\pm$0.12 (stat.) $\pm$ 0.06 (syst.)        & $10^{-5}$               \\
2.11$\pm$0.07 (stat.) $\pm$ 0.07 (syst.)        & $10^{-6}$               \\
\hline
\end{tabular}
\end{center}
