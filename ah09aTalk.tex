...
framework of heavy charged MSSM Higgs boson searches at the LHC.
\item {\bf Data:} a generator level Pythia8 data for LHC 14 TeV and 10 TeV p-p collisions 
\begin{itemize}
\item Hadronic $\tau$ decay signal
\item Hadronic jets of QCD multi-jet background
\end{itemize}
\item {\bf Goal:} 
