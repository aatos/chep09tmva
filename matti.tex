...
\item Currently (after commit
  ...
  \item[Training/test tree] The information about which jets are used
    ...
    think Lauri agrees about having the training and testing data in
  ...
  \item[Cuts vs. others] The signal/background efficiencies for other
    ...
    nature, the resulting ROC curve can (and usually will) have peaks.

  \item[Reporting in output] Can be configured.

  \item[Integration with TMVAGui.C?] Is possible.
  \end{description}
\end{itemize}
