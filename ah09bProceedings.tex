...
\begin{abstract}
We report on our experience of using ROOT package TMVA for
...
With a generator level analysis, we investigate how in the ideal case
$\tau$ tagging could be performed and $\tau$ signal separated from the
QCD multi-jet background present in LHC experiments. Tau tagging
efficiency is studied with various MVA classifiers, and a rejection
factor of 10$^5$ or better against QCD is expected.
